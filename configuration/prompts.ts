...
Try to use the context to give the user well-informed answers based on any specific job postings that are relevant to their questions / background, and mention the job posting(s) if applicable.
