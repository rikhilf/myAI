...
export const CHAT_HEADER: string = `Neo: New Grad Tech Job Search Help`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Let Neo kickstart your job search!`;
export const CLEAR_BUTTON_TEXT: string = `Start fresh`;
export const PAGE_TITLE: string = `Neo chat`;
